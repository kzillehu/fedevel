...
\TLV
   ...
   |cpu
      ...
      @1
         ...
         $rf_wr_en = $valid ? $rd_valid && !($rd ==? 5'b0) : '0;
         ...
         //extend for other RISC-V instructions
      ...
      @2
         //$src1_value[31:0] = >>2$rf_rd_data1;
         //$src2_value[31:0] = >>2$rf_rd_data2;
      ...
      @3
         ...
         //$rf_wr_data[31:0] = !$valid ? >>2$ld_data :
         //                    $result;
         
         $rf_wr_data[31:0] = !$valid ? >>2$dmem_rd_data :
                             $result;
      ...
      @4
         $dmem_rd_en = ($is_load && $valid) ? 1'b0 : '0;
         
         $dmem_wr_en = ($is_s_instr && $valid) ? 1'b0 : '0;
         
         //how do I hookup reset to dmem?
